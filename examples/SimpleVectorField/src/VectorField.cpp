...
VectorField::VectorField() {
    mFont.load("RobotoMono-Medium.ttf", FONT_SIZE);
}
...
void VectorField::setup(const int width, const int height, const int subdivision) {
    ...
    mGuiGroup.setName("Vector Field");
    mGuiGroup.add(mGuiDebugMeterPoints.set("meter points", false));
    mGuiGroup.add(mGuiDebugMeterValues.set("meter values", false));
    mGuiGroup.add(mGuiDebugVector.set("vectors", false));
}
