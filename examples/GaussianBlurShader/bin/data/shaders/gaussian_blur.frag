...
// failed function approach
// arrays of undefined size cause problems
//
//vec4 calcColor(vec2 coords[], float kernel[]) {
//    vec4 color = vec4(0.0);
//    for (int i = 0; i < coords.length(); i++) {
//        color += texture(tex0, vTexCoord + coords[i]) * kernel[i];
//    }
//}
//
//void main() {
...
//    } else {
//        vec2[] coords;
//        for (int i = -uStrength; i <= uStrength; i++) {
//            if (uVertical) {
//                coords[uStrength+i] = vec2(0.0, i);
//            } else {
//                coords[uStrength+i] = vec2(i, 0.0);
//            }
//        }
//        
//        switch (kernel_size) {
//            case 3:
//                fragColor = calcColor(coords, KERNEL_3);
//                break;
//            case 5:
//                fragColor = calcColor(coords, KERNEL_5);
//                break;
//            case 7:
//                fragColor = calcColor(coords, KERNEL_7);
//                break;
//            case 9:
//                fragColor = calcColor(coords, KERNEL_9);
//                break;
//            case 11:
//                fragColor = calcColor(coords, KERNEL_11);
//                break;
//            case 13:
//                fragColor = calcColor(coords, KERNEL_13);
//                break;
//            case 15:
//                fragColor = calcColor(coords, KERNEL_15);
//                break;
//            default:
//                break;
//        }
